...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-4">
      ...
      <main className="w-full max-w-3xl mx-auto space-y-6 sm:space-y-8 z-10 px-4 sm:px-8">
        ...
        <p className="text-base sm:text-xl text-gray-400 text-center font-light tracking-wide max-w-2xl mx-auto leading-relaxed animate-[fadeIn_0.5s_ease-out] px-4">
          Paste of URL any Website and start Asking Questions
        </p>
      </main>
      <footer className="w-full text-center py-4 mt-8 text-gray-500 text-xs sm:text-sm">
